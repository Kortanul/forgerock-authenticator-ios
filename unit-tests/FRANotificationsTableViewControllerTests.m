...
- (void)setUp {
    ...
    pushMechanism = [FRAPushMechanism pushMechanismWithDatabase:nil];
...
- (void)testShowsPendingNotificationsInFirstSection {
    // Given
    [pushMechanism addNotification:[self pendingNotificationReceivedAt:[NSDate date]]];
    [pushMechanism addNotification:[self pendingNotificationReceivedAt:[NSDate date]]];
...
- (void)testShowsCompletedNotificationsInSecondSection {
    // Given
    [pushMechanism addNotification:[self approvedNotificationReceivedAt:[NSDate date]]];
    [pushMechanism addNotification:[self deniedNotificationReceivedAt:[NSDate date]]];
...
- (void)testSortsPendingNotificationsChronologically {
    ...
    [pushMechanism addNotification:secondNotification];
    [pushMechanism addNotification:thirdNotification];
    [pushMechanism addNotification:firstNotification];
