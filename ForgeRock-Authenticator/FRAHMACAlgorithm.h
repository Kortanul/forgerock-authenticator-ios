...
/*!
 * Functions for mapping to and from the HMAC algorithm codes.
 */
@interface FRAHMACAlgorithm : NSObject

/*!
 * @param algorithm To convert to a String.
 * @return The string representation.
 */
+ (NSString *)asString:(CCHmacAlgorithm)algorithm;

/*!
 * @param string To convert back to the HMAC algorithm constant.
