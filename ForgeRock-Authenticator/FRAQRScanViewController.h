...
/*!
 * Mechanism controller for generating Mechanism instances. Exposed to allow (setter) dependency injection.
 */
@property (nonatomic, strong) FRAMechanismReaderAction* mechanismReaderAction;
